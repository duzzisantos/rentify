    ...
    <div className="admin-container">
      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data">
        ...
        <input
          type="text"
          name="wifi"
          onChange={(event) => setCreateNew({...createNew, wifi: event.target.value})}
          id="wifi"
        ...
        <input
          type="text"
          name="parking"
          onChange={(event) => setCreateNew({...createNew, parking: event.target.value})}
          id="parking"
        ...
        <input
          type="text"
          name="dis-parking"
          onChange={(event) => setCreateNew({...createNew, disabledParking: event.target.value})}
          id="dis-parking"
        ...
        <input
          type="text"
          name="bouncers"
          onChange={(event) => setCreateNew({...createNew, bouncers: event.target.value})}
          id="bouncers"
